        ...
        foreach ($pn_data as $key => $value) {
            ...
            if ($value['type'] == 1) {
                ...
                foreach ($pingxing_pn as $v) {
                    ...
                    if ($i == 0) {
                        $str .= '<div class="top-left-cover-line"></div>
                        <div class="bottom-left-cover-line"></div>';
                    } else if ($i == count($pingxing_pn) - 1) {
                        $str .= '<div class="top-right-cover-line"></div>
